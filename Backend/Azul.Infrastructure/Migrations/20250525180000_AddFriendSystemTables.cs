        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GameInvitation_NotSelf", "[FromUserId] != [ToUserId]");
                    table.ForeignKey(
                        name: "FK_GameInvitations_Users_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameInvitations_Users_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PrivateMessage_NotSelf", "[FromUserId] != [ToUserId]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameInvitations_FromUserId",
                table: "GameInvitations",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GameInvitations_ToUserId",
                table: "GameInvitations",
                column: "ToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GameInvitations_TableId",
                table: "GameInvitations",
                column: "TableId");
